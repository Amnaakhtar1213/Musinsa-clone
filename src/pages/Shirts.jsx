  ...
  return (
    <div>
      ...
      lg:grid lg:grid-cols-6 lg:gap-6 lg:overflow-visible ">
          ...
          onClick={() => toggleFavorite(702, ShirtMap[702])}></i>
              </div>
            </div>
          ...
          onClick={() => toggleFavorite(703, ShirtMap[703])}></i>
              </div>
            </div>
            <div className="flex flex-col gap-1 mt-3">
          ...
          onClick={() => toggleFavorite(704, ShirtMap[704])}></i>
              </div>
            </div>
            <div className="flex flex-col gap-1 mt-3">
          ...
          onClick={() => toggleFavorite(705, ShirtMap[705])}></i>
              </div>
            </div>
            <div className="flex flex-col gap-1 mt-3">
          ...
          onClick={() => toggleFavorite(706, ShirtMap[706])}></i>
              </div>
            </div>
            <div className="flex flex-col gap-1 mt-3">
          ...
          onClick={() => toggleFavorite(707, ShirtMap[707])}></i>
              </div>
            </div>
            <div className="flex flex-col gap-1 mt-3">
...
<div className="lg:mx-20 mx-2 md:mx-10 mt-6">
  <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
    <li className="w-full">
      <div className="relative">
        <img src={img27} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded"></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          <span className=" bg-black text-white px-2">Extra 30% OFF</span>
           <i className={`cursor-pointer ${
            favorite[708] ? "fa-solid fa-heart text-red-600" : "fa-regular fa-heart text-white"
          }`}
          onClick={() => toggleFavorite(708, ShirtMap[708])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li  className="w-full">
      <div className="relative">
        <img src={img28} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded"></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          <span className=" bg-black text-white px-2">Extra 30% OFF</span>
          <i className={`cursor-pointer ${
            favorite[709] ? "fa-solid fa-heart text-red-600" : "fa-regular fa-heart text-white"
          }`}
          onClick={() => toggleFavorite(709, ShirtMap[709])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium">SCALLYWANG</strong>
    ...
    <li  className="w-full">
      <div className="relative">
        <img src={img29} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded" ></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          <span className="bg-black text-white px-2">Extra 30% OFF</span>
          <i className={`cursor-pointer ${
            favorite[710] ? "fa-solid fa-heart text-red-600" : "fa-regular fa-heart text-white"
          }`}
          onClick={() => toggleFavorite(710, ShirtMap[710])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium">SCALLYWANG</strong>
    ...
    <li className="w-full">
      <div className="relative">
        <img src={img30} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded" ></img>
        <div className="absolute bottom-2 left-0 right-2 flex justify-between items-center px-2">
          ...
          onClick={() => toggleFavorite(711, ShirtMap[711])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium">SCALLYWANG</strong>
    ...
    <li className="w-full">
      <div className="relative">
      <img src={img31} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded"></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          <span className="bg-black text-white px-2">Extra 30% OFF</span>
           <i className={`cursor-pointer ${
            favorite[712] ? "fa-solid fa-heart text-red-600" : "fa-regular fa-heart text-white"
          }`}
          onClick={() => toggleFavorite(712, ShirtMap[712])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li className="w-full">
      <div className="relative">
        <img src={img32} alt="SCALLYWANG" className="w-full h-[400px] sm:h-[160px] md:h-[340px] lg:h-[240px] object-cover rounded"></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          <span className="bg-black text-white px-2">Extra 30% OFF</span>
           <i className={`cursor-pointer ${
            favorite[713] ? "fa-solid fa-heart text-red-600" : "fa-regular fa-heart text-white"
          }`}
          onClick={() => toggleFavorite(713, ShirtMap[713])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium">SCALLYWANG</strong>
...
<div className="mx-2 md:mx-10 lg:mx-20 mt-6">
  <ul className="flex flex-row flex-nowrap gap-4 overflow-x-auto no-scrollbar
    ...
    <li className="flex-shrink-0 w-[250px] sm:w-[150px] md:w-[200px] lg:w-full">
      <div className="relative">
        <img src={img33} alt="SCALLYWANG" className="w-full h-[300px] sm:h-[160px] md:h-[250px] lg:h-[350px] object-cover rounded"></img>
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(714, ShirtMap[715])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li className="flex-shrink-0 w-[250px] sm:w-[150px] md:w-[200px] lg:w-full">
      <div className="relative">
        ...
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(715, ShirtMap[715])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li className="flex-shrink-0 w-[250px] sm:w-[150px] md:w-[200px] lg:w-full">
      <div className="relative">
        ...
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(716, ShirtMap[716])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium">ESCAPEFROM</strong>
    ...
    <li className="flex-shrink-0 w-[250px] sm:w-[150px] md:w-[200px] lg:w-full">
      <div className="relative">
        ...
        <div className="absolute bottom-2 left-0 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(717, ShirtMap[717])}></i>
        </div>
      </div>
      <div className="flex flex-col gap-1 mt-3">
...
<section className="mx-2 lg:mx-20 md:mx-10 mt-10">
  ...
  <div>
    <img src={img135} alt="SCALLYWANG" className="w-[350px] h-[200px] object-cover lg:w-[1400px] lg:h-[550px] lg:object-cover md:object-cover md:w-[900px] md:h-[400px]"></img>
  </div>
  <div>
    <ul className="flex flex-row gap-4 mt-8
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(718, ShirtMap[718])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(719, ShirtMap[719])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(720, ShirtMap[720])}></i>
      </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
       ...
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(721, ShirtMap[721])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
    ...
    <ul className="flex flex-row gap-4 mt-8
      ...
      <li>
        ...
        <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(722, ShirtMap[722])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(723, ShirtMap[723])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">KHAKIPOINT</strong>
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(724, ShirtMap[724])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">KHAKIPOINT</strong>
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(725, ShirtMap[725])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">KHAKIPOINT</strong>
...
<section className="mx-2 lg:mx-20 md:mx-20 mt-10">
  <div className="mx-2 md:mx-10 lg:mx-20 
                  text-sm sm:text-2xl md:text-3xl lg:text-4xl 
                  font-bold text-[#0a0f18]">
    ...
    <ul className="flex flex-row gap-4 mt-8
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(726, ShirtMap[726])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(727, ShirtMap[727])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">BUAF</strong>
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(728, ShirtMap[728])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">BUAF</strong>
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(729, ShirtMap[729])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">BUAF</strong>
...
<section className="mx-2 lg:mx-20 md:mx-10 mt-10">
  <div className="mx-2 md:mx-10 lg:mx-20 
                  textsml sm:text-2xl md:text-3xl lg:text-4xl 
                  font-bold text-[#0a0f18]">
    ...
    <ul className="flex flex-row gap-4 mt-8
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(730, ShirtMap[730])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
       ...
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(731, ShirtMap[731])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">DAVIWEAR</strong>
       ...
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(732, ShirtMap[732])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">DAVIWEAR</strong>
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(733, ShirtMap[733])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium overflow-hidden text-ellipsis whitespace-nowrap w-53">DAVIWEAR</strong>
    ...
    <ul className="flex flex-row gap-4 mt-8
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(734, ShirtMap[734])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
       ...
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
         <i className={`cursor-pointer ${
          ...
          onClick={() => toggleFavorite(735, ShirtMap[735])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
      ...
      <li>
       <div className="relative">
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(736, ShirtMap[736])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
      ...
      <li>
        ...
        <div className="absolute bottom-2 right-2  flex justify-between items-center">
          ...
          onClick={() => toggleFavorite(737, ShirtMap[737])}></i>
        </div>
      </div>
        <div className="flex flex-col gap-1 mt-3">
        <strong className="font-medium text-ellipsis whitespace-nowrap w-53">MUSINSA STANDARD WOMEN</strong>
...
<div  className="mx-2 lg:mx-20 md:mx-10 mt-8">
  <ul className="flex flex-row gap-4 
    ...
    <li className="flex-shrink-0 w-full sm:w-full md:w-[400px] lg:w-[420px] snap-center">
      <div>
        <img src={img322} alt="SCALLYWANG" className="w-full h-[500px] sm:h-[500px] md:h-[500px] lg:h-[500px] object-cover rounded"/>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li className="flex-shrink-0 w-full sm:w-full md:w-[400px] lg:w-[420px] snap-center">
      <div className="relative">
        <img src={img333} alt="SCALLYWANG" className="w-full h-[500px] sm:h-[500px] md:h-[500px] lg:h-[500px] object-cover rounded"></img>
      </div>
      <div className="flex flex-col gap-1 mt-3">
    ...
    <li  className="flex-shrink-0 w-full sm:w-full md:w-[400px] lg:w-[420px] snap-center">
      <div className="relative">
        <img src={img334} alt="SCALLYWANG"  className="w-full h-[500px] sm:h-[500px] md:h-[500px] lg:h-[500px] object-cover rounded"></img>
      </div>
      <div className="flex flex-col gap-1 mt-3">
